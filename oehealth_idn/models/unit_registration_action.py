...
class unit_registration_action(models.Model):
    ...
    def view_picking(self, context):
        return {'domain': [
                    (
                     'partner_id', '=', self.patient.partner_id.id), '|', ('location_id.unit_ids.is_pharmacy', '=', True), ('location_dest_id.unit_ids.is_pharmacy', '=', True)], 
           'name': 'Action', 
           'view_type': 'form', 
           'view_mode': 'tree,form', 
    ...
    evaluation_id = fields.Many2one(comodel_name='oeh.medical.evaluation', string='Evaluation', copy=False, readonly=True)
    ...
    prescription_id = fields.Many2one(comodel_name='oeh.medical.prescription', string='Prescriptions', copy=False, readonly=True)
    ...
    newborn_id = fields.Many2one(comodel_name='oeh.medical.pediatrics.newborn', string='Newborns', copy=False, readonly=True)
    ...
    symptom_id = fields.Many2one(comodel_name='oeh.medical.pediatrics.psc', string='Pediatric Symptom', copy=False, readonly=True)
    ...
    cardiac_id = fields.Many2one(comodel_name='oeh.medical.surgery.rcri', string='Cardiac', copy=False, readonly=True)
    ...
    surgery_id = fields.Many2one(comodel_name='oeh.medical.surgery', string='Surgery', copy=False, readonly=True)
    ...
    ophthalmology_id = fields.Many2one(comodel_name='oeh.medical.ophthalmology', string='Ophthalmology', copy=False, readonly=True)
    ...
    rounding_id = fields.Many2one(comodel_name='oeh.medical.patient.rounding', string='Rounding', copy=False, readonly=True)
    ...
    ambulatory_id = fields.Many2one(comodel_name='oeh.medical.patient.ambulatory', string='Ambulatory', copy=False, readonly=True)
...
class oeh_medical_evaluation(models.Model):
    ...
    reg_id = fields.Many2one(comodel_name='unit.registration', string='Reg ID #', copy=False, readonly=True)


class oeh_medical_lab_test(models.Model):
    _inherit = 'oeh.medical.lab.test'
    reg_id = fields.Many2one(comodel_name='unit.registration', string='Reg ID #', copy=False, readonly=True)
    requestor = fields.Many2one(comodel_name='oeh.medical.physician', string='Doctor who requested the test')


class oeh_medical_imaging(models.Model):
    _inherit = 'oeh.medical.imaging'
    reg_id = fields.Many2one(comodel_name='unit.registration', string='Reg ID #', copy=False, readonly=True)
    doctor_analyzing = fields.Many2one(comodel_name='oeh.medical.physician', string='Doctor Analyzing')
...
class oeh_medical_patient_rounding(models.Model):
    ...
    inpatient_id = fields.Many2one(comodel_name='unit.registration', string='Registration Code', required=True, readonly=True, states={'Draft': [('readonly', False)]})
