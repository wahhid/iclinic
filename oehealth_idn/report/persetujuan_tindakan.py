...
class ReportPersetujuanTindakan(models.AbstractModel):
    _name = 'report.oehealth_idn.report_persetujuan_tindakan'
    ...
    def render_html(self, docids, data=None):
        ...
        _logger.info(medis)
        data.update(medis)
        return self.env['report'].render('oehealth_idn.report_persetujuan_tindakan', data)