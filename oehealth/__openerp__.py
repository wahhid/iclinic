...

{
    ...
    'summary': 'ERP Hospital Management Solutions',
...
oeHealth is a multi-user, highly scalable, centralized Electronic Medical Record (EMR) and Hospital Information System for ERP.
...
Allow your doctors and patients to login inside your oeHealth system to manage their appointments. oeHealth is tightly integrated with ERP’s calendar control so you will be always updated for your upcoming schedules.
""",
