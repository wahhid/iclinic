...
# [GCC 8.4.0]
# Embedded file name: D:\Workspaces\Odoo10\mod\Health\addons-comcustom\oehealth\oeh_medical\oeh_medical_healthcenters.py
# Compiled at: 2018-05-30 17:01:59
import logging
...
class OeHealthCentersBeds(models.Model):
    ...
    def onchange_bed_status(self, change_bed_status, state):
        ...
        if state and change_bed_status:
            ...
            elif change_bed_status == 'Mark as Reserved':
